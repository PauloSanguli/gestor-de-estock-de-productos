...
class App(Tk):
    ...
    def Create_widgets(self):
        ...
        self.Frame_Novo = Frame(self.app,bg=self.colorA,highlightbackground=self.colorC,highlightthickness=1)
        self.label_cod = Label(self.Frame_Novo,text="Codigo",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.label_name = Label(self.Frame_Novo,text="Nome producto",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.label_descr = Label(self.Frame_Novo,text="Descrição",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.label_stock = Label(self.Frame_Novo,text="Estoque",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.label_prec = Label(self.Frame_Novo,text="Preço",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.Entry_cod = Entry(self.Frame_Novo,highlightbackground=self.colorC,highlightthickness=1,background=self.colorA,bd=0,relief="flat")
        self.Entry_name = Entry(self.Frame_Novo,highlightbackground=self.colorC,highlightthickness=1,background=self.colorA,bd=0,relief="flat")
        self.Entry_descript = Entry(self.Frame_Novo,highlightbackground=self.colorC,highlightthickness=1,background=self.colorA,bd=0,relief="flat")
        self.Entry_prec = Entry(self.Frame_Novo,highlightbackground=self.colorC,highlightthickness=1,background=self.colorA,bd=0,relief="flat")
        self.Entry_stock = Entry(self.Frame_Novo,highlightbackground=self.colorC,highlightthickness=1,background=self.colorA,bd=0,relief="flat")
        self.button_Cancelar = Button(self.Frame_Novo,text="Cancelar")
        self.button_Apagar_entry = Button(self.Frame_Novo,text="Apagar")
        #Categories
        ...
        self.Frame_Actualizar = Frame(self.app,bg=self.colorA,highlightbackground=self.colorC,highlightthickness=1)
        self.label_cod2 = Label(self.Frame_Actualizar,text="Codigo",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.label_stock2 = Label(self.Frame_Actualizar,text="Estoque",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.Entry_cod2 = Entry(self.Frame_Actualizar,highlightbackground=self.colorC,highlightthickness=1,bd=0,relief="sunken")
        self.Entry_stock2 = Entry(self.Frame_Actualizar,highlightbackground=self.colorC,highlightthickness=1,bd=0,relief="sunken")
        self.button_Cancelar2 = Button(self.Frame_Actualizar,text="Cancelar")
        self.button_Apagar_entry2 = Button(self.Frame_Actualizar,text="Apagar")
        #Categories
        ...
        self.Frame_Apagar = Frame(self.app,bg=self.colorA,highlightbackground=self.colorC,highlightthickness=1)
        self.label_cod3 = Label(self.Frame_Apagar,text="Codigo",bg=self.colorA,fg=self.colorC,highlightbackground=self.colorC,highlightthickness=1)
        self.label_info3 = Label(self.Frame_Apagar,text="Insira o codigo do producto que deseja eliminar",bg=self.colorA,fg=self.colorC,font="10")
        self.Entry_cod3 = Entry(self.Frame_Apagar,background=self.colorA,bd=0,relief="sunken",highlightbackground=self.colorC,highlightthickness=1)
        self.button_Cancelar3 = Button(self.Frame_Apagar,text="Cancelar")
        self.button_Apagar_entry3 = Button(self.Frame_Apagar,text="Apagar")
        #Categories
    ...
    def Places_widgets(self):
        ...
        self.label_cod.place(relx=0.06,rely=0.06,relwidth=0.14)
        self.label_name.place(relx=0.06,rely=0.26,relwidth=0.14)
        self.label_stock.place(relx=0.06,rely=0.46,relwidth=0.14)
        self.label_descr.place(relx=0.06,rely=0.66,relwidth=0.14)
        self.label_prec.place(relx=0.06,rely=0.86,relwidth=0.14)
        self.Entry_cod.place(relheight=0.09,relwidth=0.26,relx=0.25,rely=0.06)
        self.Entry_name.place(relheight=0.09,relwidth=0.26,relx=0.25,rely=0.26)
        self.Entry_stock.place(relheight=0.09,relwidth=0.26,relx=0.25,rely=0.46)
        self.Entry_descript.place(relheight=0.09,relwidth=0.26,relx=0.25,rely=0.66)
        self.Entry_prec.place(relheight=0.09,relwidth=0.26,relx=0.25,rely=0.86)
        self.button_Apagar_entry.place(relwidth=0.2,relheight=0.09,relx=0.55,rely=0.06)
        self.button_Cancelar.place(relwidth=0.2,relheight=0.09,relx=0.55,rely=0.26)
        #Categories
        self.button_Alimentos.place(relwidth=0.12,relx=0.88,rely=0.0)
        self.button_Cozinha.place(relwidth=0.12,relx=0.88,rely=0.1)
        self.button_Vestuario.place(relwidth=0.12,relx=0.88,rely=0.2)
        self.button_Ferramentas.place(relwidth=0.12,relx=0.88,rely=0.3)
        self.button_carros.place(relwidth=0.12,relx=0.88,rely=0.4)
        self.button_mobilia.place(relwidth=0.12,relx=0.88,rely=0.5)
        self.button_aparelhos.place(relwidth=0.12,relx=0.88,rely=0.6)
        self.button_mota.place(relwidth=0.12,relx=0.88,rely=0.7)

        #Frame Actualizar
        self.label_cod2.place(relheight=0.14,relx=0.1,rely=0.3,relwidth=0.14)
        self.label_stock2.place(relheight=0.14,relx=0.1,rely=0.5,relwidth=0.14)
        self.Entry_cod2.place(relheight=0.14,relwidth=0.26,relx=0.30,rely=0.3)
        self.Entry_stock2.place(relheight=0.14,relwidth=0.26,relx=0.30,rely=0.5)
        self.button_Apagar_entry2.place(relwidth=0.15,relheight=0.14,relx=0.65,rely=0.3)
        self.button_Cancelar2.place(relwidth=0.15,relheight=0.14,relx=0.65,rely=0.5)
        #Categories
        self.button_Alimentos2.place(relwidth=0.12,relx=0.88,rely=0.0)
        self.button_Cozinha2.place(relwidth=0.12,relx=0.88,rely=0.1)
        self.button_Vestuario2.place(relwidth=0.12,relx=0.88,rely=0.2)
        self.button_Ferramentas2.place(relwidth=0.12,relx=0.88,rely=0.3)
        self.button_carros2.place(relwidth=0.12,relx=0.88,rely=0.4)
        self.button_mobilia2.place(relwidth=0.12,relx=0.88,rely=0.5)
        self.button_aparelhos2.place(relwidth=0.12,relx=0.88,rely=0.6)
        self.button_mota2.place(relwidth=0.12,relx=0.88,rely=0.7)

        #Frame Apagar
        self.label_cod3.place(relheight=0.14,relwidth=0.16,relx=0.06,rely=0.4)
        self.label_info3.place(relheight=0.14,relwidth=0.5,relx=0.06,rely=0.1)
        self.Entry_cod3.place(relheight=0.14,relwidth=0.24,relx=0.24,rely=0.4)
        self.button_Apagar_entry3.place(relwidth=0.16,relheight=0.14,relx=0.49,rely=0.4)
        self.button_Cancelar3.place(relwidth=0.16,relheight=0.14,relx=0.66,rely=0.4)
        #Categories
        self.button_Alimentos3.place(relwidth=0.12,relx=0.88,rely=0.0)
        self.button_Cozinha3.place(relwidth=0.12,relx=0.88,rely=0.1)
        self.button_Vestuario3.place(relwidth=0.12,relx=0.88,rely=0.2)
        self.button_Ferramentas3.place(relwidth=0.12,relx=0.88,rely=0.3)
        self.button_carros3.place(relwidth=0.12,relx=0.88,rely=0.4)
        self.button_mobilia3.place(relwidth=0.12,relx=0.88,rely=0.5)
        self.button_aparelhos3.place(relwidth=0.12,relx=0.88,rely=0.6)
        self.button_mota3.place(relwidth=0.12,relx=0.88,rely=0.7)
...
class Events(App):
    ...
    def ButtonActualizar_clicked(self):
        ...
        self.Frame_Actualizar.place(relheight=0.4,relwidth=0.9,relx=0.05,rely=0.4)   
    ...
    def ButtonNovo_clicked(self):
        ...
        self.Frame_Novo.place(relheight=0.4,relwidth=0.9,relx=0.05,rely=0.4)
    ...
    def ButtonApagardb_clicked(self):
        ...
        self.Frame_Novo.place(relheight=0,relwidth=0)
        self.Frame_Actualizar.place(relheight=0,relwidth=0)
        self.Frame_Apagar.place(relheight=0.4,relwidth=0.9,relx=0.05,rely=0.4)  
